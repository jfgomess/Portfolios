...
pag_fornecedor = planilha_fornecedores['Sheet1']

for linha in pag_fornecedor.iter_rows(min_row=2, values_only=True):
    ...
    CONTRATANTE: Safebyte Tecnologia
    E-mail: safebyte@safebyte.com

    Castanhal,{datetime.now().strftime('%d/%m/%Y')}

    """
    arquivo_word.add_paragraph(contrato)
